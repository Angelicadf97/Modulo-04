            ...
            <section>
                ...
                <form>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-6 col-md-4 mb-2">
                            <label for="inputChildren" class="form-label">Crianças entre 2 e 17
                                anos</label>
                        ...
                        <div class="carousel-inner text-center">
                            <div class="carousel-item active">
                                ...
                                <div class="carousel-caption d-md-block bg-opacity-50 bg-black">
                                    <h5 class="text-white">SÃO PAULO-SP</h5>
                            ...
                            <div class="carousel-item">
                                ...
                                <div class="carousel-caption d-md-block bg-opacity-50 bg-black">
                                    <h5><a href="ofertas-hos.html #bra" class="text-white">BRASÍLIA-DF</a></h5>
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div>
                                            <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas"
                                                ...
                                                aria-controls="offcanvasWithBothOptions">Diárias</button>
                                            ...
                                            <div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1"
                                                ...
                                                <div class="offcanvas-body">
                                                    ...
                                                    <div>
                                                        <!--Pac01-->
                                                        <div class="card mb-3">
                                                            <img src="../IMG/fortaleza/Hotel_Brasil_tropical-300x200.png"
                                                                class="card-img-top" alt="...">
                                                            <div class="card-body">
                                                                <h5 class="card-title">Nacional Inn Curitiba Torres</h5>
                                                                <p class="card-text">A partir de <strong>Qua 17 Ago</strong> Até <strong> Sex 19 Ago</strong></p>
                                                                <p class="small">1 Quarto - 1 Cama casal</p>
                                                                <p class="small">Diária</p>
                                                        ...
                                                        <div class="card mb-3">
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <p class="card-text">A partir de <strong>Qua 17
                                                                        Ago</strong> Até <strong> Sex 19 Ago</strong>
                                                                </p>
                                                                <p class="small">1 Quarto - 1 Cama casal</p>
                                                                <p class="small">Diária</p>                                                                   pessoa</small></p>
                                                                <p class="card-text"><small>R$</small><big>120,00</big></p>
                                                            </div>
                                                        </div>
                                                        <!--Pac02-->
                                                        <!--Pac03-->
                                                        <div class="card mb-3">
                                                            <img src="../IMG/fortaleza/portal_praia_hotel-300x200.png"
                                                                class="card-img-top" alt="...">
                                                            <div class="card-body">
                                                                <h5 class="card-title">Nacional Inn Curitiba Torres</h5>
                                                                <p class="card-text">A partir de <strong>Qua 17
